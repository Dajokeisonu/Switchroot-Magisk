...
- If you are getting an error enter ```sudo apt install binfmt-support qemu qemu-user-static``` This should resolve the `` cannot execute binary file: Exec format error``
